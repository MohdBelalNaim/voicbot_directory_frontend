  ...
  Widget _buildError(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: const Color(0xFFFFF1F2), borderRadius: BorderRadius.circular(24)),
        child: Column(
          children: [
            const Icon(Icons.wifi_off_rounded, color: Color(0xFFBE123C), size: 28),
            const SizedBox(height: 8),
            Text('Could not connect to server',
                style: GoogleFonts.plusJakartaSans(fontSize: 13, fontWeight: FontWeight.w600, color: const Color(0xFFBE123C))),
            const SizedBox(height: 8),
            GestureDetector(
          ...
          return Padding(
            ...
            child: GestureDetector(
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => DetailScreen(customer: c, colorIndex: index)),
              ),
              child: Container(
                height: 70,
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Container(
                            width: 46, height: 46,
                            decoration: BoxDecoration(color: _bg(index), borderRadius: BorderRadius.circular(14)),
                            child: Center(
                              child: Text(
                                c.initials,
                                style: GoogleFonts.plusJakartaSans(
                                  fontSize: c.initials.length > 2 ? 10 : 13,
                                  fontWeight: FontWeight.w700, color: _fg(index),
                                ),
                              ),
                            ),
                          ),

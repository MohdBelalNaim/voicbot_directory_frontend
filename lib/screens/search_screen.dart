...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void _navigateTo(BuildContext context, Customer c, int colorIndex) {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (_) => DetailScreen(customer: c, colorIndex: colorIndex)),
    );
  }
                ...
                child: ListView(
                  ...
                  children: [
                    if (recents.isNotEmpty && _query.isEmpty)
                      _buildRecentsSection(context, recents),
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final c =
                    Customer(id: chat.customerId, name: chat.customerName);
                return Padding(
        ...
        children: [
          ...
          if (results.isEmpty)
            ...
            ...results.asMap().entries.map((e) {
              ...
              return _buildBotRow(
                  context, e.value, colorIndex < 0 ? 0 : colorIndex);
            }),
        ],
      ),
    );
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    height: 44,
                    decoration: BoxDecoration(
                        color: _bg(colorIndex), shape: BoxShape.circle),
                    child: Center(
                      child: Text(c.initials,
                          style: GoogleFonts.plusJakartaSans(
                              fontSize: c.initials.length > 2 ? 10 : 13,
                              fontWeight: FontWeight.w700,
                              color: _fg(colorIndex))),
                    ),
                  ),
                  const SizedBox(width: 14),
                  Expanded(
